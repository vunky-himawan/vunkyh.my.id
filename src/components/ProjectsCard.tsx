            ...
            >
              <div className="relative z-2">
                ...
                <div className="text-xl h-max py-3 capitalize flex flex-col gap-2">
                  <h4 className="font-bold text-4xl font-cabinet">
                    {data.title}{" "}
                  </h4>
                  <h5
                    className={`w-fit ${
...
const Skeleton = () => {
  return (
    <>
      ...
      <div className="text-xl h-max py-3 capitalize flex flex-col gap-2">
        <div className="h-[2.25rem] w-full bg-gray-100 animate-pulse rounded-xl"></div>
        <div className="h-[1rem] w-[80%] bg-gray-100 animate-pulse rounded-xl"></div>
        <div className="h-[1rem] w-[70%] bg-gray-100 animate-pulse rounded-xl"></div>
        <div className="h-[1rem] w-[80%] bg-gray-100 animate-pulse rounded-xl"></div>
        <div className="h-[1rem] w-[70%] bg-gray-100 animate-pulse rounded-xl"></div>
      </div>
    </>
